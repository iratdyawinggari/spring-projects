...
import com.enigma.finalproject.fuzzy.membership.Membership;
...
public class FuzzySet implements Serializable, Cloneable {
    ...
    protected Map<String, Membership> mMemberships = new HashMap<String, Membership>();
    ...
    {
        Map<String, List<Double>> degrees = new HashMap<String, List<Double>>();
        for (int i = 0; i < mValues.size(); ++i)
        {
            degrees.put(mValues.get(i), new ArrayList<Double>());
        }
